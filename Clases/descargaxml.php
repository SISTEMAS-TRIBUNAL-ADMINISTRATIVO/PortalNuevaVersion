<?php
    ...
    if(isset($_POST['descargamxl']))
    {
      ...
      $query = mysqli_query($mysqlDell,"SELECT CAST(cfdi_xml_cfdi AS character) as XML FROM pri_cfdi WHERE id_cfdi=".$idEmpleado) or die(mysqli_error());
    ...
    else if (isset($_POST['descargapdf'])) 
    {
      ...
      $query = mysqli_query($mysqlDell,"SELECT cfdi_pdf_timbrado FROM pri_cfdi WHERE id_cfdi=".$idEmpleado) or die(mysqli_error());
      $row = mysqli_fetch_array($query);
