 ...
 * @author TRIBUNAL ADMINISTRATIVO DEL PODER JUDICIAL DE CHIAPAS
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'TRIBUNAL ADMINISTRATIVO DEL PODER JUDICIAL DE CHIAPAS');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "UNIDAD DE APOYO ADMINISTRATIVO / AREA DE INFORMATICA \nSISTEMA DE RESGUADO DE BINES INFORMATICOS ");

define ('PDF_HEADER_TITLE2', 'CONTROL INTERNO');
